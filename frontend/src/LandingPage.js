...
const LandingPage = () => {
    ...
    return (
        <div>
                ...
                <div>
                    <div className="row align-items-center">
                        <div className="col-md-4">
                            <p style={{ fontWeight: "bold" }} className="h1">
                                Discover the Creativity of Campus
                            </p>
                            <p>
                                Explore a vibrant showcase of student projects from across the
                                college. Find inspiration, connect with creators, and get involved
            ...
            <div
                className="row d-flex justify-content-around mt-5 p-5"
            ...
            >
                ...
                <div className="col-md-4 text-center">
                    ...
                    <p>
                        Engage with the campus community and stay up-to-date on the latest projects
                        and events.
                    </p>
                </div>
            </div>
