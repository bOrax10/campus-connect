...
const CommentSection = ({ item, setItem }) => {
    ...
    const handleDeleteReply = (commentIndex, replyId) => {
        setItem((prevItem) => ({
            ...prevItem,
            comments: prevItem.comments.map((comment, index) => {
                    ...
                    <div className="d-flex">
                        ...
                        <div className="dropdown ms-auto">
                            <button
                                ...
                                type="button"
                                id={`dropdownMenuButton-${commentIndex}`}
                            ...
                            <ul
                                ...
                                aria-labelledby={`dropdownMenuButton-${commentIndex}`}
                            >
                                <li>
                                    <button
                                        ...
                                        {reply.username === userData.username && (
                                            <div className="dropdown ms-auto">
                                                <button
                                                    className="btn text-secondary"
                                                    type="button"
                                                    id={`replyDropdown-${commentIndex}-${replyIndex}`}
                                                    data-bs-toggle="dropdown"
                                                    aria-expanded="false"
                                                >
                                                    <i className="fas fa-ellipsis-v"></i>
                                                ...
                                                <ul
                                                    className="dropdown-menu dropdown-menu-end"
                                                    aria-labelledby={`replyDropdown-${commentIndex}-${replyIndex}`}
                                                >
                                                    <li>
                                                        <button
                                                            className="dropdown-item"
